...
![Nginx版本信息](/public/image/nginx-V.png)
...
![Nginx进程模型](/public/image/process-model.png)
...
![正向代理示意图](/public/image/forward-proxy.png)
...
![反向代理示意图](/public/image/reverse-proxy.png)
...
![Go服务器示例](/public/image/go-server-8084.png)
